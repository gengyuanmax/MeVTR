...
from dataloaders.dataloader_activity_multisentence import ActivityNet_DataLoader
# from dataloaders.dataloader_activity_multisentence import ActivityNet_DataLoader_16 as ActivityNet_DataLoader
from dataloaders.dataloader_didemo_retrieval import DiDeMo_DataLoader
from dataloaders.dataloader_charades_multi import Charades_Dataloader
...
DATALOADER_DICT = {"msrvtt": {"train": dataloader_msrvtt_train, "val": dataloader_msrvtt_test, "test": None},
                   ...
                   "lsmdc": {"train": dataloader_lsmdc_train, "val": dataloader_lsmdc_test,
                             "test": dataloader_lsmdc_test},
                   "activity": {"train": dataloader_activity_train, "val": dataloader_activity_test, "test": None},
                   "didemo": {"train": dataloader_didemo_train, "val": dataloader_didemo_test,
